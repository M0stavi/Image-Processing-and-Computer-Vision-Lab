# -*- coding: utf-8 -*-
"""
Created on Tue May 10 18:06:01 2022
...
plt.title("Input for scharr: ")

plt.show()

kernel_v = np.array(([-3,0,3],[-10,0,10],[-3,0,3]),np.float32)

kernel_h = np.array(([-3,-10,-3],[0,0,0],[3,10,3]),np.float32)
